    ...
    <section className='w-full h-screen relative overflow-hidden flex'>
      <div className='w-full h-auto z-10 flex mt-20 lg:mt-0 items-start lg:items-center lg:h-screen absolute'>
        <div className='text-start space-y-4 px-8 w-full'>
          <h1 className='poppins-extrabold text-4xl text-gray-800'>Unlock Your Potential: <br /> Learn & Teach Skills With Ease!</h1>
          <p className='poppins-medium opacity-75 lg:w-[40%] text-gray-600'>Join a community where talent meets opportunity. Learn from experts or share your knowledge with those eager to grow.</p>
      ...
      <div className=' w-full h-full -z-10 '>
        <div className='right-80 bottom-40 absolute -rotate-90 z-10' ref={aeroplaneRef}>
